...
class OverlayView(context: Context?, attrs: AttributeSet?) : View(context, attrs) {
    ...
    private fun initPaints() {
        ...
        boxPaint.color = ContextCompat.getColor(context!!, android.R.color.holo_red_light)
    ...
    fun setResults(boundingBox: List<BoundingBox>) {
        boundingBox.firstOrNull()?.let {
            layoutParams.width = it.w.toInt()
            layoutParams.height = it.h.toInt()
        } ?: return
